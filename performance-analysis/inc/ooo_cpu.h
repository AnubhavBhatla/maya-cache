...
#define DEADLOCK_CYCLE (1000000 * 1000)
...
class O3_CPU {
  public:
    ...
    uint64_t sim_rob_stall_cycle, sim_rob_stall_counter, roi_rob_stall_cycle, roi_rob_stall_counter,roi_load_rob_stall_counter,roi_load_rob_stall_cycle;
	...
	fetch_resume_cycle = 0;
        ...
        sim_rob_stall_cycle = 0;
        roi_rob_stall_cycle = 0;
        sim_rob_stall_counter = 0;
        roi_rob_stall_counter = 0;
